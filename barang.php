                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>" . $row['nama'] . "</td>";
                                            echo $row['deskripsi'] == "" ? "<td>-</td>" : "<td>" . $row['deskripsi'] ."</td>";
                                            
                                            if ($update_barang != "0_0" || $delete_barang != "0_0") {
                                                echo "<td class='text-center'>";
                                                if ($update_barang != "0_0") {
                                                    echo "<button class=\"btn btn-primary btn-xs siku\" onclick='passsingdataubahbarang(". $row['id'] .")' title=\"Ubah Barang " . $row['nama'] . "\">Ubah</button></a>";
                                                }
                                                if ($delete_barang != "0_0") {
                                                    echo "<button class=\"btn btn-danger btn-xs siku\" onclick=\"deletebarang(". $row['id'] .")\" title=\"Hapus Barang " . $row['nama'] . "\">Hapus</button>";
                                                }
                                                echo "</td>";
                                            }
                                            echo "</tr>";
...
<!--                <div class="col-md-4">
                    ...
                    <div class="panel-body">
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            if ($succeed) {
                                ...
                                echo "swal({";
                                echo "    title: 'Berhasil menambahkan barang baru',";
                                echo "    type: 'success',";
                    ...
                    <?php
                        if ($succeed) {
                            ...
                            echo "<strong>BERHASIL !</strong> Telah berhasil menambahkan barang baru.";
                            echo "</div>";
                        }
                    ?>
                        <form role="form" method="post" action="barang" style="">
       ...
       $(document).ready(function(){
        ...
        function passsingdataubahbarang(id) {
            ...
            $('#myTable tbody').on( 'click', 'tr', function () {
                ...
                $("#modal-barangKode").val(row[1]);
                $("#modal-barangName").val(row[2]);
                $("#modal-barangKeterangan").val(row[3]);
            } );
