...
<html lang="en">
    <head>
        ...
        <title>Tambah Transaksi - ayooreward!</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form role="form" method="post" action="tambah-transaction" style="min-height: 410px;">
                            ...
                            <div class="form-group">
                                <label>Tanggal</label>
                                <input type="text" readonly="true "name="transDate" class="form-control siku" id="transDate" data-select="datepicker" accept="" readonly="true" placeholder="Pilih Tanggal" onclick="removeError(this.id)" style="background-color: White; cursor: pointer;" />
                                <?php
                                    if ($dateErr) {
                                        echo "<i class=\"validation-text\" id=\"val-transDate\">" . $dateErr . "</i>";
                                    }
                                ?>
                            </div>
<!--                            <div class="form-group">
