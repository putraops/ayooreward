...
<html lang="en">
    <head>
        ...
        <title>Tambah Jenis Reward - ayooreward!</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        <strong>TAMBAH JENIS REWARD</strong>
                    </h1>
                </div>
            </div>
            <!-- /.row -->
                ...
                <div class="col-md-5">
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            if (isset($_POST["submit"])) {
                                if (!$isError) {
                                    $sql = "INSERT INTO db_jenis_reward (nama, isDelete, created_at, updated_at) "
                            ...
                            if ($succeed) {
                                echo "<script>";
                                echo "swal('Berhasil menambahkan ". $rewardName ." ke dalam daftar jenis reward!');";
                                echo "</script>";
                    ...
                    <?php
                        if ($succeed) {
                            ...
                            echo "<br/>Untuk melihat daftar Jenis Reward lihat <a href='jenis-reward' >disini.</a>";
                            echo "</div>";
                    ...
                    <div class="panel panel-default siku">
                        <div class="panel-heading">
                          <h3 class="panel-title">FORM TAMBAH JENIS REWARD</h3>
                        </div>
                        <div class="panel-body">
                            <form role="form" method="post" action="tambah-jenis-reward" style="">    
