...
<html lang="en">
    <head>
        ...
        <title>Edit Kontak Person - ayooreward!</title>
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        <strong>UBAH DATA KONTAK PERSON</strong>
                    </h1>
                </div>
            </div>
            <!-- /.row -->
            ...
            <?php
                ...
                if ($kode == "") {
                    echo "<script>window.location.assign('contactperson');</script>";
                }

                
                $sql = "Select u.nama as nama, u.email as email, u.telp as telp  
                        From db_contactperson u
                        where id = '$kode'";
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    $userNama = isset($_POST['userNama']) ? trim($_POST['userNama']) : '';
                        ...
                        if (!$isError) {
                            try {
                                ...
                                if ($succeed) {
                                    ...
                                    echo "<script>";
                                    echo "swal({";
                                    echo "     title: \"Berhasil mengubah data kontak person\",";
                                    echo "     type: \"success\",";
                                    ...
                                    echo "     if (isConfirm) {  ";
                                    echo "         window.location.assign('edit-contactperson?k=".$kode."');";
                                    echo "     }";
                                    echo " }); ";
                                    echo "</script>";
                                }
            ...
            <div class="row">
                <div class="col-md-6">
                    <form role="form" method="post" action="edit-contactperson?k=<?php echo $kode;?>" style="padding-bottom: 100px;">
                        <div class="panel panel-default siku">
                            <div class="panel-footer siku" style="background-color: white">
                                <div class="form-group">
                                    <label>Nama</label>
                                    <input class="form-control siku" name="userNama" id="userNama" onkeyup="removeError(this.id)" placeholder="Masukkan Nama" value="<?php echo $userNama;?>">
                                    <?php
                                        if ($nameErr) {
                                            echo "<i class=\"validation-text\" id=\"val-userNama\">" . $nameErr . "</i>";
                                        }
                                    ?>
                                </div>
                                <div class="form-group">
