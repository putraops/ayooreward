...
<!--                    <form class="form-inline">
                    ...
                    <form class="" style="margin: 5px 0px 5px 0px;">
                        <div class="form-group">
                            ...
                            <select id="vendor-laporan" onclick="removeErrorText(this.id)" style="padding: 5px;">
                                <option value="0" <?php echo $is_vendor == "" || $is_vendor == "0" ? "selected" : ""; ?>>Semua Vendor</option>
                                <?php
                        ...
                        <div class="form-group">
                            ...
                            <select id="status-laporan" onclick="removeErrorText(this.id)" style="padding: 5px;">
                                <option value="0" <?php echo $is_status == "" || $is_status == "0" ? "selected" : ""; ?>>Semua Reward</option>
                                <?php
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        $lastid = "";
                                        while ($row = $result->fetch_assoc()) {
                                            echo "<option ". ($is_status == $row['kode'] ? 'selected' : '' ). " value='". $row['kode'] ."'>" . $row['nama'] . "</option>"; 
                                        }
                                    }
                                ?>
                            </select>
