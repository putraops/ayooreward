...
<html lang="en">
    <head>
        ...
        <title>Edit Brand - ayooreward!</title>
...
//                    echo "</script>";
                    ...
                    if (isset($_POST["submit"])) {
                        if (!$isError) {
                            ...
                            if ($succeed) {
                                ...
                                echo "<script>";
                                echo "swal({";
                                echo "     title: \"Berhasil mengubah data brand\",";
                                echo "     type: \"success\",";
                                ...
                                echo "     if (isConfirm) {  ";
                                echo "         window.location.assign('edit-brand?q=".$currentKode."');";
                                echo "     }";
                                echo " }); ";
                                echo "</script>";
                            }
            ...
            <?php
                if ($succeed) {
                    ...
                    echo "<strong>BERHASIL !</strong> Telah berhasil mengubah data brand. Lihat daftar brand <a href='brand'>disini</a>";
                    echo "</div>";
                }
            ?>
            <div class="row col-md-6">
                ...
                <div class="panel panel-default siku">
                    <div class="panel-heading">
                      <h3 class="panel-title">FORM UBAH DATA BRAND</h3>
                    </div>
